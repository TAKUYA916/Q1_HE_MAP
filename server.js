...
// Helper to get bucket reference
const bucket = storage.bucket(BUCKET_NAME);

// Load endpoint - スロット対応
...
// GitHub proxy endpoint - CORS回避のため
app.get('/github-proxy', async (req, res) => {
    try {
        ...
        console.log(`[GITHUB-PROXY] Successfully fetched ${content.length} bytes`);
